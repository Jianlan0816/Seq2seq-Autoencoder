...
if __name__ == "__main__":
    ...
    parser.add_argument("dirpath", type=str, default="/content/drive/MyDrive/seq2seq_derivative/models/best")
    parser.add_argument("--train_path", type=str, default="/content/drive/MyDrive/seq2seq_derivative/data/train_set.txt")
    parser.add_argument("--test_path", type=str, default="/content/drive/MyDrive/seq2seq_derivative/data/test_set.txt")
