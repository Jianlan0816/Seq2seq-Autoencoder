...
if __name__ == "__main__":
    ...
    parser.add_argument("--datapath", type=str, default="/content/drive/MyDrive/seq2seq_derivative/data/train.txt")
    parser.add_argument("--trainpath", type=str, default="/content/drive/MyDrive/seq2seq_derivative/data/train_set.txt")
    parser.add_argument("--testpath", type=str, default="/content/drive/MyDrive/seq2seq_derivative/data/test_set.txt")
